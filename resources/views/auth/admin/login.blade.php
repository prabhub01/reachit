...
<link rel="stylesheet" type="text/css" href="{{ asset('backend/css/pages/authentication.min.css') }}">
@endsection
@section('scripts')
@endsection
@section('content')
                ...
                <div class="auth-inner row m-0">
                    ...
                    <div class="d-none d-lg-flex col-lg-8 align-items-center p-5">
                        <div class="w-100 d-lg-flex align-items-center justify-content-center px-5">
                            <img class="img-fluid" src="{{ asset('/backend/images/login-v2.svg') }}" alt="Login V2" />
                        </div>
                    </div>
                    <!-- /Left Text-->
                    <!-- Login-->
                    <div class="d-flex col-lg-4 align-items-center auth-bg px-2 p-lg-5">
                        <div class="col-12 col-sm-8 col-md-6 col-lg-12 px-xl-2 mx-auto">
                            ...
                            <form class="auth-login-form mt-2 needs-validation" action="" method="POST" novalidate>
