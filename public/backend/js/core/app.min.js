...
(window.colors = {
    solid: { primary: "#7367F0", secondary: "#82868b", success: "#28C76F", info: "#00cfe8", warning: "#FF9F43", danger: "#EA5455", dark: "#4b4b4b", black: "#000", white: "#fff", body: "#f8f8f8" },
    light: { primary: "#7367F01a", secondary: "#82868b1a", success: "#28C76F1a", info: "#00cfe81a", warning: "#FF9F431a", danger: "#EA54551a", dark: "#4b4b4b1a" },
}),
    (function (a, e, t) {
        "use strict";
        var s = t("html"),
        ...
        if (
            ("laravel" === t("body").attr("data-framework") && (r = t("body").attr("data-asset-path")),
                t.fn.dataTable && t.extend(t.fn.dataTable.ext.classes, { sFilterInput: "form-control", sLengthSelect: "form-select" }),
                t(a).on("load", function () {
                    ...
                    t('a[data-action="collapse"]').on("click", function (a) {
                        ...
                        t(".touchspin-cart").TouchSpin({ buttondown_class: "btn btn-primary", buttonup_class: "btn btn-primary", buttondown_txt: feather.icons.minus.toSvg(), buttonup_txt: feather.icons.plus.toSvg() }),
                    ...
                    "horizontal-menu" != l && !1 === r && t(".main-menu-content").find("li.active").parents("li").addClass("open"),
                        "horizontal-menu" == l && (t(".main-menu-content").find("li.active").parents("li:not(.nav-item)").addClass("open"), t(".main-menu-content").find("li.active").closest("li.nav-item").addClass("sidebar-group-active open"));
                    var i = t(".chartjs"),
                    ...
                    t(".char-textarea").on("keyup", function (e) {
                        !(function (e, s) {
                            ...
                            t(".char-count").html(e.value.length),
                                e.value.length > n
                                    ? (r.css("background-color", a.colors.solid.danger), l.css("color", a.colors.solid.danger), l.addClass("max-limit"))
                                    : (r.css("background-color", a.colors.solid.primary), l.css("color", o), l.removeClass("max-limit"));
                        })(this, e),
        ...
        // i18next.use(a.i18nextXHRBackend).init({ debug: !1, fallbackLng: "en", backend: { loadPath: r + "data/locales/{{lng}}.json" }, returnObjects: !0 }, function (a, e) {
        ...
        t(".search-list-main").mouseenter(function () {
                            ...
                            for (var m = 0; m < a.listItems.length; m++) {
                                ...
                                0 == a.listItems[m].name.toLowerCase().indexOf(e) &&
                                    ...
                                    ((o +=
                                        ...
                                        a.listItems[m].url +
                                        '><div class="d-flex justify-content-start align-items-center">' +
                                        feather.icons[a.listItems[m].icon].toSvg({ class: "me-75 " }) +
                                        "<span>" +
                                        a.listItems[m].name +
                                        "</span></div>" +
                                        h +
            ...
            t(e).on("click", ".bookmark-input .search-list .bookmark-icon", function (a) {
                if ((a.stopPropagation(), t(this).hasClass("text-warning"))) {
                    ...
                    (n = '<li class="nav-item d-none d-lg-block"><a class="nav-link" href="' + o + '" data-bs-toggle="tooltip" data-bs-placement="bottom" title="' + r + '">' + feather.icons[l].toSvg({ class: "ficon" }) + "</a></li>"),
            ...
            t(a).on("keydown", function (e) {
                ...
                if (
                    (40 === e.keyCode ? ((s = o.next()), o.removeClass("current_item"), (o = s.addClass("current_item"))) : 38 === e.keyCode && ((n = o.prev()), o.removeClass("current_item"), (o = n.addClass("current_item"))),
            ...
            t(".form-password-toggle .input-group-text").on("click", function (a) {
                ...
                "text" === o.attr("type")
                    ...
                    : "password" === o.attr("type") && (o.attr("type", "text"), feather && n.find("svg").replaceWith(feather.icons["eye-off"].toSvg({ class: "font-small-4" })));
            }),
            t(a).on("scroll", function () {
                (t(this).scrollTop() > 400 ? t(".scroll-top").fadeIn() : t(".scroll-top").fadeOut(), n.hasClass("navbar-static")) &&
                    (t(a).scrollTop() > 65
                        ? (t("html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed").css({ background: "#fff", "box-shadow": "0 4px 20px 0 rgba(0,0,0,.05)" }),
                            t(".horizontal-menu.dark-layout .header-navbar.navbar-fixed").css({ background: "#161d31", "box-shadow": "0 4px 20px 0 rgba(0,0,0,.05)" }),
                        ...
                        : (t("html:not(.dark-layout) .horizontal-menu .header-navbar.navbar-fixed").css({ background: "#f8f8f8", "box-shadow": "none" }),
            ...
            (e = "dark-layout" !== a ? "dark-layout" : a === n ? "light-layout" : n || "light-layout"),
                ...
                (function (a) {
                    ...
                    s.removeClass("semi-dark-layout dark-layout bordered-layout"),
                        "dark-layout" === l
                            ? (s.addClass("dark-layout"), o.removeClass("menu-light").addClass("menu-dark"), r.removeClass("navbar-light").addClass("navbar-dark"), e.find(".ficon").replaceWith(feather.icons.sun.toSvg({ class: "ficon" })))
                            : "bordered-layout" === l
